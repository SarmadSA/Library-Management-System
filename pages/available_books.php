                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php
                                $result = "SELECT b.ISBN, b.title, b.Language, b.Year, (SELECT COUNT(DISTINCT bc.Copy_ID))
                                ...
                                while ($row = $res1->fetch()) {
                                    ...
                                    $year = $row[3];
                                    $numOfCopies = $row[4];
                                    echo '<tr>' . '<td>' . $ISBN . '</td>' . '<td>' . $title . '</td>' .
                                        '<td>' . $language . '</td>' . '<td>' . $year . '</td>' . '<td>' . $numOfCopies . '</td>'. '</tr>';
                                }
                                ?>
                                </tbody>
                            </table>
