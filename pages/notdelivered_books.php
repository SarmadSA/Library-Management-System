...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="notdelivered_books.php">Not Returned Loans</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Not Returned Loans</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php
                                $result = "SELECT l.ID, bc.copy_ID, bC.ISBN, b.title, u.First_Name, l.Start_Date, l.Due_Date
                                            FROM loans l, returns r, Book_copies bc, book b, user u
                                ...
                                while ($row = $res1->fetch()) {
                                    ...
                                    echo '<tr>' . '<td>' . $loan_id . '</td>' . '<td>' . $book_id . '</td>' .
                                        '<td>' . $ISBN . '</td>' . '<td>' . $title . '</td>' . '<td>' . $borrower . '</td>'.
